...
class CAHierarchyBuilder:
    ...
    def build(self):
        ...
        ee = self.create_smartcard_cert(sica_private_key, ee_private_key, outpath="ee.pem")
    ...
    def create_smartcard_cert(self, issuer_private_key, private_key, outpath=None):
        subject_entries = [
            (NameOID.COUNTRY_NAME, "US"),
            (NameOID.ORGANIZATION_NAME, "My Company"),
